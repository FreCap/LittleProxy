...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
     ...
     * </p>
     */
    public ConnectionFlowStep MitmEncryptClientChannel = new ConnectionFlowStep(
            this, HANDSHAKING) {
        @Override
        ...
        @Override
        protected Future<?> execute() {
            return ClientToProxyConnection.this
                    ...
                    .addListener(
                            new GenericFutureListener<Future<? super Channel>>() {
                                ...
                                public void operationComplete(
                                        ...
                                        throws Exception {
                                    if (future.isSuccess()) {
                                        ClientToProxyConnection.this.setMitming(true);
                                    }
                                }
                            });
        }
